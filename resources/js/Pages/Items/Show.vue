...
<!--    </div>-->
    ...
    <div class="flex-row sm:flex">
        <div class="col-span-12 mx-auto py-3 sm:px-3 lg:px-6">
        ...
        <div
            class="col-span-2 h-full flex flex-col text-center bg-white rounded-lg shadow divide-y divide-gray-200"
        >
            ...
            <div>
                <div class="-mt-px flex divide-x divide-gray-200 px-8">
                    <div class="-ml-px w-0 flex-1 flex">
                        <span v-if="resp == 'waiting'" class="relative w-0 flex-1 inline-flex items-center justify-center py-4 text-sm text-gray-700 font-medium border border-transparent rounded-br-lg hover:text-gray-500">Awaiting Response</span>
                        <span v-else-if="resp == 'accepted'" class="relative w-0 flex-1 inline-flex items-center justify-center py-4 text-sm text-gray-700 font-medium border border-transparent rounded-br-lg hover:text-gray-500">{{ $page.props.auth.user.email }}</span>
                        <a
                            v-else
                            @click="open = true"
