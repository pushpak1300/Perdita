                        ...
                        <div
                            ...
                            <div>
                                ...
                                <h1 class="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:leading-none lg:mt-6 lg:text-5xl xl:text-6xl">
                                    <span class="md:block">What you've lost</span>
                                    <!-- space -->
                                    <span class="text-indigo-400 md:block">will be given a chance to be found</span>
                                </h1>
                                <p class="mt-3 text-base text-gray-400 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                                    Have you <span class="text-white">lost</span> or <span class="text-white">found</span> something valuable and are clueless as to, what you could do to about it?
                                </p>
                                <p class="mt-3 text-base text-gray-400 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                                    Firstly, take a deep breath. Because we've got you covered.
                                </p>
                                <p class="mt-8 text-sm text-white uppercase tracking-wide font-semibold sm:mt-10">Simple as ever</p>
                                <div class="mt-5 w-full sm:mx-auto sm:max-w-lg lg:ml-0">
                                    <div class="flex flex-wrap items-start justify-between">
                                        <div class="flex justify-flex-start px-1 align-items-center">
                                            <svg class="w-12 h-12" fill="none" stroke="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path></svg>
                                            <h3 class="tracking-light text-white  sm:mt-5 sm:leading-none lg:mt-4 lg:text-xl xl:text-xl">Log in</h3>
                                        </div>
                                        <div class="flex justify-flex-start px-1">
                                            <svg class="w-12 h-12" fill="none" stroke="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path></svg>
                                            <h3 class="tracking-light text-white  sm:mt-5 sm:leading-none lg:mt-4 lg:text-xl xl:text-xl">Upload details</h3>
                                        </div>
                                        <div class="flex justify-flex-start px-1">
                                            <svg class="w-12 h-12" fill="none" stroke="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 21h7a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v11m0 5l4.879-4.879m0 0a3 3 0 104.243-4.242 3 3 0 00-4.243 4.242z"></path></svg>
                                            <h3 class="tracking-light text-white  sm:mt-5 sm:leading-none lg:mt-4 lg:text-xl xl:text-xl">Look for it</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
